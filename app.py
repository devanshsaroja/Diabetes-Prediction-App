...
X = data.drop(['Outcome', 'DiabetesPedigreeFunction','SkinThickness','BMI','Insulin'], axis=1)  # Adjust the column name as per your dataset
y = data['Outcome']
...
if st.button("Predict"):
    ...
    input_data = np.array([[pregnancy, glucose, blood_pressure, age]])
